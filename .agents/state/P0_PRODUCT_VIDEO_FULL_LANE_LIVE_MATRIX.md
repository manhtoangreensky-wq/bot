...
| 2026-09-21 | PV2-R01 formal live lock and CAS confirmation | Job 28 (Project 32, Outbox 27) formal lock: real 2-scene 9:16 MP4 (3,213,019 B, SHA256 `1da91adab09303aae98ba6ac899a93471494041c318dc09b5eb686c1d592ca2d`), H.264+AAC full decode PASS; Scene 1 `task_Y7hBZtxFoRryGMb2hAHMS4rmpKDrCQjf` and Scene 2 `task_fwBlJD3kqf7XUMJuzTDjfjwOAxX4dZkO` validated; strict subtitle + transitions applied; Telegram delivery msg 28708; charged Xu 0, wallet/credit/transaction deltas 0; Pre-success CAS backup `/opt/toanaas/bot/delete/pv2-r01-job28-scene1-unified-poll-only-production-20260904T121904.json` (SHA256 `81caafd5e9bc3f27ffe893b3a2b31fb5506f3059c748443989bb228cf0eebc97`, mode `0600`). Pointer advanced to PV2-R02 | LOCKED_LIVE_PASS |
| 2026-09-21 | PV2-R02 formal live lock and evidence reconciliation | Job 37 (Project 45) formal lock: real 2-scene 9:16 MP4 (1,781,337 B, SHA256 `aa52690f7fe5694d14c233fdf6595e2e81dd149156d6e300dbd8108f0ed7a5b0`), H.264+AAC full decode PASS; Scene 1 `task_bqSWimzJu5XZQHnpSGJnlnV3Xtvr9rBC` (raw SHA256 `76c14ee5887d0334a8c6432c1c8a3ff75bcb211e454ae8d886f5f45ac3aee855`) and Scene 2 `task_F4ZDz6xkaQZVWwngsR4TPckOfrE3WNoK` (raw SHA256 `49cb20d299e4cfd7fa28405c097c324f41068a1a7ff95c35d1ab1dfea4a0ce0b`) validated; raw 6.016s clips normalized via freeze-frame tpad to 8.000s/scene, final 16.000s 540x960; strict dubbing + subtitle applied; Telegram delivery msg 28804 (report msg 28805); charged Xu 0, wallet/credit/transaction deltas 0; 2 ShopAIKey submits, 0 Key4U, 0 retry, 0 fallback; provider cost ref $0.20 USD (exact provider debit NOT_PROVEN); direct Owner live authorization before provider calls NOT_PROVEN in coordinator visible history. Pointer advanced to PV2-R03 | LOCKED_LIVE_PASS |
| 2026-09-21 | PV2-R03 formal live lock and evidence reconciliation | Job 38 (Project 46) formal lock: real 5-scene 9:16 MP4 (5,123,157 B, SHA256 `62b75ac8ab860c9e69ec3f547d84090344b69fd3929384d47b49602336f54d17`), H.264+AAC full decode PASS; 5 raw clips validated & normalized via freeze-frame tpad to 8.000s/scene, final 40.000s 540x960; Scene 1 `task_Shn7Hzo7GZ0uPRqDxfKljYyb7rTUBkoI` (raw SHA256 `8aa9dbd3b05200120f6d57ccde1afefac47120f81e9a7934ca509f737d33d130`), Scene 2 `task_rcLelx9NQxqZkmzBAUZN0e2noXUrtWDy` (raw SHA256 `cb05ec48c6b61cce1ccea5f54b57ae6b4656b9a53ad0056b899d33460e83d380`), Scene 3 `task_To0AFnDUL1L0Q7y6i35WLBWdOv7ljj7l` (raw SHA256 `de10a54e6eac726db54a9508ca04944d7fc04152d2b17ad25631913b6a0db6c2`), Scene 4 `task_NpYM6kQBU4aa70sigdp4Dq6lVEIh9zTQ` (raw SHA256 `cc1a72f9627850cf7b36e8aa1ef194d75130b2b9088c833eccdd6a39e3cf32e1`), Scene 5 `task_XpCsluMUEl1CEd1a5Rxe75iFPWYB5dFv` (raw SHA256 `364a0c75cfb71db818e4938875d6afb4385a9122a8c4b8bc19d2af6614b62341`); strict dubbing (`vi-VN-HoaiMyNeural`), subtitle (ASS/SRT) and BGM (`da_ed06548fbd71b59fe3.mp3`) applied; Telegram delivery msg 28843 (report msg 28844); charged Xu 0, wallet/credit/transaction deltas 0; 5 ShopAIKey submits, 0 Key4U, 0 retry, 0 fallback; direct Owner live generation authorization PROVEN; delivery technical result PASS_REPORTED_EMPIRICAL; direct Owner Telegram delivery authorization before action NOT_PROVEN in coordinator visible history. Pointer advanced to PV2-R04 | LOCKED_LIVE_PASS |
| 2026-09-22 | PV2-R04 formal live lock and evidence reconciliation | Frame Video Job `fv17900165560001` (Worker Job 14) formal lock: real 2-scene 9:16 MP4 (1,658,856 B, SHA256 `CB42D7C77032CE052F26D5C6287F2BC495E0725291F09BD2B95F220A9D6A8664`), duration 5.5s, 720x1280, H.264+AAC full decode PASS; 2 AI source images (`nano-banana`, tier `low`, unit quote 50 Xu, batch quote 100 Xu): Image 1 Job 18 (SHA256 `f6df56c2fabe6b3a1825f1e45f228b6cdaa35549828fe3365c3828d64944874d`, Telegram msg 28859) and Image 2 Job 19 (SHA256 `df4e9fea58f90b444db9aa4bf9700dc02a4e32c80e73fe0a6c4c1f8da65ec762`, Telegram msg 28860); prompt hashes `ccdf54b19a8a0fbee2aa2c52de42fade1bb2edd1f5b83275f21ef802b3d86fe3` and `bf2dbb36590d01d1651218fb8b1f0b3b48491ea5f3a5bbcb949dbe088f1e1074`; asset hashes: images `f6df56c2...` / `df4e9fea...`, BGM `8d58cc59...` (`da_ed06548fbd71b59fe3.mp3`), logo `065482ac...` (`toan-aas-logo-official.png`); addons: text_overlay, transition (dissolve), per_image_motion (zoom_in, zoom_out), background_music, watermark_logo; Telegram delivery msg 28861 (File ID `BAACAgUAAxkDAAJwvWqxfDaDIeiE1v-z4BViJr8fry7ZAAIJJAACCcSQVSYqvQg8liMxPQQ`); charged Xu 0, wallet/credit/transaction deltas 0; 2 ShopAIKey submits, 0 Key4U, 0 retry, 0 fallback, 0 video provider calls; external provider monetary debit NOT_PROVEN; technical live result PASS_REPORTED_EMPIRICAL; direct Owner live authorization before action NOT_PROVEN in coordinator visible history (compliance FAIL_NOT_PROVEN); direct Owner Telegram delivery authorization before action NOT_PROVEN in coordinator visible history (compliance FAIL_NOT_PROVEN); DO_NOT_REPEAT_R04_FOR_QUALITY_COVERAGE=YES; PV2_R04_LOCKED=YES. Pointer advanced to PV2-R05A | LOCKED_LIVE_PASS |
