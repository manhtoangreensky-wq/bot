...
`/start` clears six small text/navigation pending states while preserving
document/archive upload state and protected media producer state. This change is
source/test evidence only until runtime deployment is verified.
