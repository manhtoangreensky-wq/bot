...
BASE_PRICING_CATALOG: dict[str, dict[str, Any]] = {
    ...
    "video_tier_400": {
        ...
        "label": "Video AI Nhanh gọn (Tier 400)",
        "unit": "scene",
        "base_value": 80,
        "value_type": "int",
        "editable": True,
    ...
    "video_tier_500": {
        ...
        "product_key": "video_ai_prompt",
        "label": "Video AI Chuyển động ổn định (Tier 500)",
        "unit": "scene",
        "base_value": 110,
        "value_type": "int",
        "editable": True,
    ...
    "video_tier_600": {
        ...
        "product_key": "video_ai_prompt",
        "label": "Video AI Chuyển động có âm thanh (Tier 600)",
        "unit": "scene",
        "base_value": 160,
        "value_type": "int",
        "editable": True,
    ...
    "video_tier_200": {
        ...
        "product_key": "video_ai_prompt",
        "label": "Video AI Cân bằng rõ nét (Tier 200)",
        "unit": "scene",
        "base_value": 200,
        "value_type": "int",
        "editable": True,
    ...
    "video_tier_300": {
        ...
        "product_key": "video_ai_prompt",
        "label": "Video AI Tiêu chuẩn có âm thanh (Tier 300)",
        "unit": "scene",
        "base_value": 220,
        "value_type": "int",
        "editable": True,
    ...
    "video_tier_700": {
        ...
        "product_key": "video_ai_prompt",
        "label": "Video AI Cảnh dài có âm thanh (Tier 700)",
        "unit": "scene",
        "base_value": 220,
        "value_type": "int",
        "editable": True,
    ...
    "video_tier_800": {
        ...
        "product_key": "video_ai_prompt",
        "label": "Video AI Cao cấp linh hoạt (Tier 800)",
        "unit": "scene",
        "base_value": 370,
        "value_type": "int",
        "editable": True,
    ...
    "video_tier_1000": {
        ...
        "product_key": "video_ai_prompt",
        "label": "Video AI Diễn xuất chân thật (Tier 1000)",
        "unit": "scene",
        "base_value": 370,
        "value_type": "int",
        "editable": True,
    ...
    "video_tier_1200": {
        ...
        "product_key": "video_ai_prompt",
        "label": "Video AI Đa góc máy (Tier 1200)",
        "unit": "scene",
        "base_value": 1260,
        "value_type": "int",
        "editable": True,
    ...
    "video_tier_1500": {
        ...
        "product_key": "video_ai_prompt",
        "label": "Video AI Điện ảnh nhiều cảnh (Tier 1500)",
        "unit": "scene",
        "base_value": 2360,
        "value_type": "int",
        "editable": True,
