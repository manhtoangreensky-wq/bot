...
FRAME_VIDEO_ROUTE_MATRIX = {
    ...
    "motion_set": {"owner": "handle_frame_video_canonical_callback", "screen": "audio", "back": "motion"},
    ...
    "addons": {"owner": "handle_frame_video_canonical_callback", "screen": "audio", "back": "motion", "mutation": "legacy_redirect"},
    "audio_menu": {"owner": "handle_frame_video_canonical_callback", "screen": "audio", "back": "motion_or_review"},
    "audio_done": {"owner": "handle_frame_video_canonical_callback", "screen": "branding", "back": "audio"},
    "audio_skip": {"owner": "handle_frame_video_canonical_callback", "screen": "branding", "back": "audio"},
    "addons_done": {"owner": "handle_frame_video_canonical_callback", "screen": "branding", "back": "audio", "mutation": "legacy_redirect"},
    "addons_skip": {"owner": "handle_frame_video_canonical_callback", "screen": "branding", "back": "audio", "mutation": "legacy_redirect"},
    "branding": {"owner": "handle_frame_video_canonical_callback", "screen": "branding", "back": "audio"},
    "branding_confirm": {"owner": "handle_frame_video_canonical_callback", "screen": "branding", "back": "position"},
    "addon": {"owner": "handle_frame_video_canonical_callback", "screen": "addon_input", "back": "audio_or_branding"},
    "position_menu": {"owner": "handle_frame_video_canonical_callback", "screen": "position", "back": "branding_or_text_editor"},
    "position_set": {"owner": "handle_frame_video_canonical_callback", "screen": "branding_confirm_or_text_editor", "back": "position"},
    ...
    "review": {"owner": "handle_frame_video_canonical_callback", "screen": "review", "back": "branding"},
