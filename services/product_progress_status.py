...
PRODUCT_PROGRESS_SPECS: dict[str, dict[str, Any]] = {
    ...
    "subdub": {
        ...
        "back_callback": "videodub|back_type",
        "steps": [
            _stage("received_file", "Nhận video", "Đã nhận video", 5),
            _stage("extracting_audio", "Tách âm thanh", "Đang tách âm thanh", 20),
...
def product_progress_debug_payload(product_type: str = "", job_id: str = "", job: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    if normalize_product_type(product_type) in VIDEO_PROGRESS_TYPES:
        for key in (
            ...
            "dispatch_first_due_claim_attempted",
            "dispatch_last_claim_failure_reason",
            "dispatch_last_claim_failure_at",
            ...
            "premature_dispatch_failure_recoverable",
            "premature_dispatch_recovery_used",
            "premature_dispatch_recovered_at",
            "premature_dispatch_recovered_reason",
            "dispatch_status_authority",
            "dispatch_canonical_status",
            "dispatch_public_stage",
            "dispatch_status_consistent",
