...
def test_video_menu_all_buttons_have_product_registry():
    ...
    assert [len(row) for row in markup.inline_keyboard] == [2, 2, 2, 1]
    ...
    for hidden_product_id in ("video_trend", "video_idea", "storyboard_prompt", "script_image_video", "frame_video_local", "multi_scene_film", "video_local_edit", "motion_prompt", "video_reference", "audio_addons"):
