    ...
    async def _run():
        ...
        async def mock_prepare(_st):
            return {
                ...
                "output_segments": [{"start": 0.0, "end": 2.0, "text": "Xin chao"}],
            }
    ...
    async def _run():
        ...
        async def mock_prepare(_st):
            return {
                ...
                "content_type": "video/mp4",
                "source_segments": [{"start": 0.0, "end": 2.0, "text": "Hello 44100"}],
                "output_segments": [{"start": 0.0, "end": 2.0, "text": "Xin chao 44100"}],
            }
