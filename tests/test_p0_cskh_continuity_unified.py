...
def _routing_text_update(text: str, user_id: int = 77):
    message = _RoutingReplyMessage(text)
...
def test_message_dispatch_deduplicates_same_chat_message(monkeypatch):
    ...
    update = _routing_text_update("hello")
...
def test_video_trim_input_is_owned_and_does_not_fall_through_to_chat(monkeypatch):
    ...
    update = _routing_text_update("00:10-00:40", user_id=uid)
