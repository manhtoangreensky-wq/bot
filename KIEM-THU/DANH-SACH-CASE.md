...
| `SD-AUTO-MULTI-PROVIDER-DURATION-01` | Auto Multi nhận media `180.545s`, normalized audio `180.566333s`, provider metadata `duration=181s`, word cuối `end=180.900s` | Word timeline phải được chấp nhận và clamp về `180.566s`, cho phép pipeline đi qua acoustic; metadata không phải số nguyên hoặc chênh `>=0.5s`, word vượt bound sau tolerance, NaN, giảm thời gian hoặc duplicate phải bị từ chối an toàn. Không tạo job mới trong unit test và không charge. |
