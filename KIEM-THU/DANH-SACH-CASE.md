...
| `SD-AUTO-MULTI-PROVIDER-DURATION-01` | Auto Multi nhận media `180.545s`, duration orchestration làm tròn `181s`, provider metadata `duration=181s`, terminal word bắt đầu trong media và kết thúc qua EOF | Word timeline phải được chấp nhận và clamp cả khi provider duration bằng duration làm tròn; terminal span tối đa `2.5s`. Metadata chênh `>=0.5s`, word không phải cuối vượt bound, word bắt đầu ngoài media, NaN, giảm thời gian hoặc duplicate phải bị từ chối an toàn. Nếu reject, receipt chỉ lưu reason/index/count aggregate, tuyệt đối không raw word/text/timestamp. Không tạo job mới trong unit test và không charge. |
